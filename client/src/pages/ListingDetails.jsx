   ...
   <div className='flex items-start max-md:flex-col gap-10'>
    ...
    border-gray-200 p-5 max-md:mb-10'>
      ...
      {listing.isCredentialChanged && (
        <button  onClick={purchaseAccount} className='w-full mt-2 bg-purple-600 text-white py-2
      rounded-lg hover:bg-purple-700 transition text-sm font-medium flex items-center
      justify-center gap-2'>
